...
enum class AsanaClass {
    ...
    fun getFormattedString(): String {
        val string = when (this) {
            ...
            bharadvajasana_i -> "bharadvajasana 1"
            bhekasana -> "bhekasana"
            ...
            eka_pada_koundinyanasana_i -> "eka pada koundinyanasana 1"
            eka_pada_koundinyanasana_ii -> "eka pada koundinyanasana 2"
            eka_pada_rajakapotasana -> "eka pada rajakapotasana"
            eka_pada_rajakapotasana_ii -> "eka pada rajakapotasana 2"
            ...
            malasana -> "malasana"
            marichyasana_i -> "marichyasana 1"
            marichyasana_iii -> "marichyasana 3"
            ...
            virabhadrasana_iii -> "virabhadrasana 3"
            virasana -> "virasana"
